...
namespace NZWalks.DAL.Migrations
{
    ...
    [Migration("20230415100332_seedingData")]
            ...
            modelBuilder.Entity("NZWalks.Domain.Models.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("33fdfec8-6c89-4df1-977c-19e8dcb4f19c"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("d1aedf65-ee5f-4f22-9313-24503657d465"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("c5e6308d-79e6-42ac-8ec0-28d214656099"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("NZWalks.Domain.Models.Region", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fe38bc11-e820-4c0f-8413-dfe3eb32c1b0"),
                            Code = "AKL",
                            Name = "Auckland"
                        },
                        new
